...
% setting variables
PSE_biasAll=[biasVes biasVis] %depandent variable
...
aoctool(STAITForAncova,PSE_biasAll,modalityLabel) %ancova test

%  figure settings
set(f(1), 'color','b')
set(f(3), 'color','b')
set(f(2), 'color','r','marker','o')
set(f(4), 'color','r')
set(f(1), 'color','b')

% % % axis labels and legends needs to be added manually
